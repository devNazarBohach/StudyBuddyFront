...
function makeStyles(fs: (n: number) => number) { return StyleSheet.create({
  ...
  subtitle: { marginTop: 2, fontSize: fs(13) },
  ...
  senderName: { fontSize: fs(12), marginBottom: 4, marginLeft: 4 },
  bubble: { borderRadius: 18, paddingHorizontal: 14, paddingVertical: 10 },
  bubbleText: { fontSize: fs(15), marginTop: 2 },
  ...
  input: { flex: 1, minHeight: 46, maxHeight: 120, borderRadius: 16, paddingHorizontal: 14, paddingVertical: 12, fontSize: fs(15) },
