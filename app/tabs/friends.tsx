...
const openDirectChat = async (username: string) => {
  ...
  return (
    <ThemedView style={styles.container}>
      ...
      <Pressable style={styles.sectionBtn} onPress={() => router.push("./screens/friends/friendRequests")}>
        <ThemedText style={{ fontWeight: "600" }}>
          Friend requests {adminMode ? "(mock)" : "(backend)"}
        </ThemedText>
      </Pressable>

      <Pressable style={styles.sectionBtn} onPress={() => router.push("./screens/friends/addFriend")}>
